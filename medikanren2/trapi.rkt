      ...
      (if (null? nodes)
          ...
          (let* ((id+n        (car nodes))
            ...
            (if curies
                ...
                (if (pair? categories)
                    (let ((categories (if (or reasoning? (use-reasoning?))
                                          (subclasses/set categories) categories)))
      ...
      (if (null? edges)
          ...
          (let* ((id+e      (car edges))
            ...
            (if (and predicates (not (pair? predicates)))
                ...
                (let ((predicates (if (or reasoning? (use-reasoning?))
