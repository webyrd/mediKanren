...
(define EDGEPROP_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/robokop_march/full_Robokop.edgeprop.tsv")
(define EDGE_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/robokop_march/full_Robokop.edge.tsv")
(define QUALIFIED_EDGE_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/robokop_march/full_Robokop.qualifiededge.tsv")
(define NODEPROP_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/robokop_march/full_Robokop.nodeprop.tsv")
;;
(define OUTPUT_DATABASE_PATH "../../neo-data/full_Robokop.db")
