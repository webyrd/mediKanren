...
(define EDGEPROP_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/baseline_Robokop/baseline_Robokop.edgeprop.tsv")
(define EDGE_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/baseline_Robokop/baseline_Robokop.edge.tsv")
(define NODEPROP_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/baseline_Robokop/baseline_Robokop.nodeprop.tsv")
;;
(define OUTPUT_DATABASE_PATH "../../neo-data/baseline_Robokop.db")
