...
(define EDGEPROP_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/node_normalization/node_normalization.edgeprop.tsv")
(define EDGE_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/node_normalization/node_normalization.edge.tsv")
(define NODEPROP_PATH "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/node_normalization/node_normalization.nodeprop.tsv")
;;
(define OUTPUT_DATABASE_PATH "../../neo-data/node_normalization.db")
