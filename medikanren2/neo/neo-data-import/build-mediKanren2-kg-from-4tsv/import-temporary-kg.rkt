...
(provide import-temporary-kg)

(define-runtime-path path.here ".")

(define (import-temporary-kg output-database-name raw-data-folder-name)

  (define OUTPUT_DATABASE_PATH (string-append "../../neo-data/" output-database-name ".db"))
  (define BASE (path->string (build-path path.here (string-append "../../neo-data/raw_downloads_from_kge_archive_transformed_to_4tsv/" raw-data-folder-name "temporary_kg"))))
  (define EDGEPROP_PATH (string-append BASE ".edgeprop.tsv"))
  (define EDGE_PATH (string-append BASE ".edge.tsv"))
  (define NODEPROP_PATH (string-append BASE ".nodeprop.tsv"))
